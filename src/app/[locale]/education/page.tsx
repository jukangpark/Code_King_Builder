        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "기초 과정",
                description: "HTML, CSS, JavaScript 기초부터 시작",
                duration: "3-5시간",
                topics: [
                  "HTML 구조",
                  "CSS 스타일링",
              ...
              {
                title: "중급 과정",
                description: "React, Next.js 프레임워크 학습",
                duration: "5-8시간",
                topics: ["React 컴포넌트", "상태 관리", "라우팅", "API 연동"],
              },
              {
                title: "고급 과정",
                description: "실제 비즈니스 웹사이트 개발",
                duration: "8-12시간",
                topics: [
                  "프로젝트 기획",
                  "디자인 시스템",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              전문가와 함께 웹 개발의 모든 것을 배우고, 자신만의 프로젝트를
              완성해보세요.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
